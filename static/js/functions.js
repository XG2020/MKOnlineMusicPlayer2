...
function searchBox() {
    ...
    // '       <label class="leo-label"><input class="leo-radio" type="radio" name="source" value="xiami"><span class="leo-radioInput"></span><img class="leo-img"  src="static/images/s-xiami.png"></label>' + 
    '       <label class="leo-label"><input class="leo-radio" type="radio" name="source" value="kugou"><span class="leo-radioInput"></span><img class="leo-img"  src="static/images/s-kugou.png"></label>' + 
    // '       <label class="leo-label"><input class="leo-radio" type="radio" name="source" value="baidu"><span class="leo-radioInput"></span><img class="leo-img"  src="static/images/s-baidu.png"></label>' + 
    '   <p style="font-size:10px; text-align:center;">tips：付费歌曲无法播放，下载</p>' +
    '   </div>' + 
    '</div></form>';

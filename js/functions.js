...
function searchBox() {
    ...
    '    <div class="search-group"  style="border-radius:5px;">' + 
    '        <input type="text" style="border-radius:5px;" name="wd" id="search-wd" placeholder="搜索歌手、歌名、专辑" autofocus required>' + 
    '        <button class="search-submit" style="border-radius:6px; color:#fff; border: none; background-color: red;" type="submit">搜 索</button>' + 
    '    </div>' + 
    ...
    '   </div>' + 
    '   <div style="font-size:10px;"><br>tips：付费歌曲无法播放，下载</div>' + 
    '</div></form>';
    layer.open({
        type: 1,
        shade: false,
